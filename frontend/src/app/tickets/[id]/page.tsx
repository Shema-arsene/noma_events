...
function TicketDetail() {
  ...
  if (isError || !data) return <ErrorState message="Billet introuvable." onRetry={() => refetch()} />;
        ...
        <div className="p-6 text-center">
          ...
          <div className="my-6 flex justify-center">
            {isActive && data.qrImage ? (
              ...
              <img src={data.qrImage} alt="QR code du billet" width={220} height={220} className="rounded-lg" />
            ) : (
          ...
          <dl className="space-y-2 text-left text-sm">
            <Row label="Titulaire" value={data.attendeeName} />
            <Row label="Type de billet" value={data.ticketTypeName} />
            <Row label="Lieu" value={data.event.city} />
            <Row label="Référence" value={data.displayCode} />
          </dl>
        </div>
      </div>
    </div>
